...
CREATE TABLE IF NOT EXISTS rich_results_reports (
    ...
    validate_google BOOLEAN NOT NULL DEFAULT TRUE,
    validate_schema_org BOOLEAN NOT NULL DEFAULT TRUE,
    ...
    google_validation_result JSONB,
    schema_org_validation_result JSONB,
